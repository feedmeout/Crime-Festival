  ...
  suspects: [
    {
      ...
      motive: 'Το θύμα της χρωστούσε 3 μισθούς. Γνώριζε για τον καρκίνο - έκλεινε ραντεβού με ογκολόγους για λογαριασμό του',
	  notes: 'Σκεφτόταν να παραιτηθεί αλλά δεν ήθελε να αφήσει τον προϊστάμενό της λόγω των προβλημάτων υγείας του. Μοναδικό άτομο με πρόσβαση σε όλους τους κωδικούς και κλειδιά. Φάρμακα αλπραζολάμη στο συρτάρι της (7ος όροφος). ΑΛΛΑ: Σιδηρένιο άλλοθι επιβεβαιωμένο από ανεξάρτητες πηγές',
	  relationship: '«Πατρική φιγούρα» - έκλαιγε στην ανάκριση',
    ...
    },
    {
      ...
      other: 'Πρόσβαση σε όλους τους ορόρφους. Γνωρίζει συνδυασμούς χρηματοκιβωτίων'
    },
    {
      id: 'eleni',
	  ...
	  motive: 'Ερωτικές φωτογραφίες στον φάκελο - απειλή δημοσιοποίησης και εκβιασμός €100.000. Θα κατέστρεφε την καριέρα και τον γάμο της',
	  notes: 'Αναφέρει ότι συναντήθηκε σύντομα με το θύμα για να συζητήσουν εκδοτικά θέματα. Τεχνικές γνώσεις πληροφορικής (background πριν γίνει συγγραφέας). Πρόσβαση σε email accounts λόγω της συνεργασίας τους',
    ...
    },
    {
	  ...
	  notes: 'Έλεγχος βάρδιας: Σάρωσε κάρτα στον 7ο όροφο 20:22 (ψηφιακό log). Μάρτυρας τον είδε στον 3ο όροφο 20:48 (26 λεπτά αργότερα). Το τυπικό μοτίβο περιπολίας είναι: 7ος → 5ος → 3ος → 1ος → 7ος (διάρκεια κύκλου: 30-40 λεπτά). Η παρουσία του στον 3ο όροφο στις 20:48 συνάδει με τη ρουτίνα του.',
    ...
    },
    {
	  ...
	  motive: 'Έκλεβε χειρόγραφα συγγραφέων για ανταγωνιστικό εκδοτικό οίκο - θύμα την ανακάλυψε και την απείλησε με απόλυση',
	  notes: 'Ζήτησε άδεια για 24/09 πριν 1 εβδομάδα. Δεν κράτησε απόδειξη από καφετέρια (ισχυρισμός 18:30-20:30). Συγγενής με γιατρό - θεωρητική πρόσβαση σε φάρμακα. Πρόσβαση σε εταιρική πιστωτική κάρτα. ΑΛΛΑ: Δεν είχε λόγο να γνωρίζει για τον καρκίνο, ούτε πρόσβαση σε κυάνιο',
