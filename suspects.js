  ...
  suspects: [
    {
      ...
      alibi: 'Έφυγε 18:00 για ραντεβού με γιατρό (Δρ. Κωστόπουλος, 18:30-19:30 επιβεβαιωμένο). Δείπνο με αδελφή μετά (19:45-22:30, μάρτυρας υπό εξέταση)',
    ...
    },
    {
      ...
      other: 'Ζήτησε άδεια για 03/11 πριν 1 εβδομάδα'
    }
  ],
