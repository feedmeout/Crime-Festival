    ...
    🎮 ΕΚΚΙΝΗΣΗ ΠΑΙΧΝΙΔΙΟΥ
            ...
            document.getElementById('app').innerHTML = `
                <div class="form-section active center-content">
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        <button class="btn btn-primary" onclick="window.close(); if(!window.closed) window.location.href='28392index.html?team=${TEAM_MEMBER.team}'" style="font-size: clamp(14px, 2.5vw, 16px);">
